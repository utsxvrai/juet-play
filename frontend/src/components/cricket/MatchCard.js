      ...
      <div className="mb-4 space-y-2">
        <div className="flex justify-between items-center">
          <div className="flex items-center min-w-0">
            <img src={teamA.logo} alt={teamA.name} className="w-8 h-8 rounded-full mr-2 border-2 border-slate-600 flex-shrink-0"/> 
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center min-w-0">
            <img src={teamB.logo} alt={teamB.name} className="w-8 h-8 rounded-full mr-2 border-2 border-slate-600 flex-shrink-0"/> 
